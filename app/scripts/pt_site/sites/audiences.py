...
from ..parser.audiences import AudiencesParser
...
class AudiencesSite(BasePTSite):
    """Audiences站点实现"""
    ...
    def __init__(self):
        ...
        self.category_mapping = {
            ...
            402: CategoryDetail(id=402, name="剧集", params="cat=402"),
            403: CategoryDetail(id=403, name="综艺", params="cat=403"),
            406: CategoryDetail(id=406, name="记录片", params="cat=406"),
            408: CategoryDetail(id=408, name="音乐", params="cat=408"),
            8: CategoryDetail(id=8, name="动画", params="tag=8"),
        }
        super().__init__(config, AudiencesParser())
...
def main():
    """主函数 - 仅用于测试"""
    print("这是Audiences站点的测试函数")
    print("实际使用时请通过API调用相关功能")
