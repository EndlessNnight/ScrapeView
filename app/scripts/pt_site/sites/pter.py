...
from ..schemas import TorrentInfo, TorrentDetails, SiteConfig, PTUserInfo, Category, CategoryDetail, TorrentInfoList
from ..parser.pter import PterParser
...
class PTerSite(BasePTSite):
    ...
    def __init__(self):
        ...
        self.category_mapping = {
            ...
            403: CategoryDetail(id=403, name="动漫", params="cat=403"),
            404: CategoryDetail(id=404, name="电视剧", params="cat=404"),
            405: CategoryDetail(id=405, name="综艺", params="cat=405"),
            406: CategoryDetail(id=406, name="音乐", params="cat=406"),
            402: CategoryDetail(id=402, name="纪录片", params="cat=402"),
            1: CategoryDetail(id=1, name="艺术", params="incldead=1&spstate=0&inclbookmarked=0&search=LikeArt&search_area=0&search_mode=0"),
        }
        super().__init__(config, PterParser())
