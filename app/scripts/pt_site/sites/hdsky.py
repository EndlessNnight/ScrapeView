...
class HDSkySite(BasePTSite):
    ...
    def __init__(self):
        ...
        self.category_mapping = {
            401: CategoryDetail(id=401, name="电影", params="cat401=1&cat410=1"),
            402: CategoryDetail(id=402, name="电视剧", params="cat402=1&cat411=1&cat412=1&cat413=1"),
            403: CategoryDetail(id=403, name="综艺", params="cat403=1"),
            404: CategoryDetail(id=404, name="纪录片", params="?cat404=1"),
            405: CategoryDetail(id=405, name="动漫", params="cat=405"),
            406: CategoryDetail(id=406, name="音乐", params="cat406=1&cat408=1"),
            407: CategoryDetail(id=407, name="体育", params="cat407=1"),
        }
